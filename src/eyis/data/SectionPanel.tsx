  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "min-w-0",
          !flush && (title ? "px-4 pt-1 pb-5 sm:px-5" : "p-4 sm:p-5"),
          bodyClassName,
        )}
      >
        {children}
...
export function SectionLink({
  ...
  return (
    <Link
      to={to}
      {...(params ? { params } : {})}
      className="-mr-1.5 inline-flex min-h-11 items-center gap-0.5 rounded-md px-1.5 text-sm font-medium text-primary hover:underline"
    >
      {children}
