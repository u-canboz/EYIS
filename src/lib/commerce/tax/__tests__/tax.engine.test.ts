...
function rate(
  over: Partial<TaxRateRule> & { taxClassId: string; countryCode: string; rateBasisPoints: number },
): TaxRateRule {
  return {
    ...
    lines: [
      {
        ...
        variantId: "v1",
        quantity: 1,
        lineTotalMinor: 11900,
        taxClass: standardClass,
      },
    ],
    rates,
        ...
        lines: [
          {
            ...
            variantId: "v1",
            quantity: 2,
            lineTotalMinor: 10700,
            taxClass: reducedClass,
          },
        ],
      }),
    );
