...
export const INTEGRATION_CATALOG: IntegrationCatalogEntry[] = [
  ...
  },
  {
    ...
    healthCheckSupported: true,
    disconnectSupported: true,
    configurationRequirements: ["Client-ID", "Secret", "Webhook-ID"],
    capabilities: ["paypal", "refunds", "webhooks"],
    documentationReference: "https://developer.paypal.com",
    managePath: "/app/zahlungen",
    note: "Verbindung über REST-Zugangsdaten (Client-ID und Secret). Sandbox und Live sind getrennt.",
  },
  {
    id: "mollie",
    category: "payment",
    displayName: "Mollie",
    description: "Europäische Zahlungsarten (iDEAL, Bancontact, SEPA, Karten).",
    connectionType: "api_credentials",
    implemented: true,
    testOnly: false,
    testModeSupported: true,
    healthCheckSupported: true,
    disconnectSupported: true,
    configurationRequirements: ["API-Schlüssel"],
    capabilities: ["card", "ideal", "bancontact", "sofort", "refunds", "webhooks"],
    documentationReference: "https://docs.mollie.com",
    managePath: "/app/zahlungen",
    note: "Der Schlüsselpräfix bestimmt die Umgebung: test_ oder live_.",
  },
  // ---- E-Mail ----
  {
    id: "lovable",
  ...
  },
  {
    ...
    healthCheckSupported: true,
    disconnectSupported: true,
    configurationRequirements: ["SMTP-Host", "Port", "TLS-Modus", "Zugangsdaten", "Absenderadresse"],
    capabilities: ["transactional"],
    documentationReference: null,
    managePath: "/app/kommunikation/regeln",
    note: "Nur verschlüsselte Verbindungen (direktes TLS oder STARTTLS). Zustellberichte und Bounce-Webhooks gibt es bei SMTP nicht.",
  },
  {
    id: "resend",
    category: "email",
    ...
    healthCheckSupported: true,
    disconnectSupported: true,
    configurationRequirements: ["Resend-API-Schlüssel", "Webhook-Secret (optional)"],
    capabilities: [
      "transactional",
      "domain_verification",
      "delivery_webhooks",
    ...
    managePath: "/app/einstellungen/integrationen",
    note: null,
  },
