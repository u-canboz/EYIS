...
| 4 | Zentrale Logo-Komponente mit Varianten (full, wordmark, wordmark-claim, mark, icon) | PASS | `src/eyis/brand/EyisLogo.tsx` |
| 5 | Backoffice-Shell: Wordmark in Sidebar, Mark in Icon-Rail | PASS | `src/eyis/shell/AppShell.tsx` |
